...
const CEO_REGISTRY: CeoMeta[] = [
  ...
  { id: 'pichai', name: 'Sundar Pichai', role: 'CEO @ Alphabet', company: 'Alphabet', photo: 'https://unavatar.io/twitter/sundarpichai', logo: '/logos/google.svg', color: '#4285F4', aliases: ['sundar pichai', 'alphabet', 'google'] },
