...
import { LoaderCircle, ChevronRight, Globe } from 'lucide-react';
        ...
        <section className="max-w-7xl mx-auto px-6 w-full text-left">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8 border-l-4 border-cyan-500 pl-8">
            ...
            <div className="hidden lg:block pb-4">
               <div className="p-6 bg-white/[0.02] border border-white/5 rounded-[30px] flex items-center gap-6">
                  <div className="flex flex-col">
                     <span className="text-[8px] font-black text-gray-600 uppercase tracking-widest">Estado de Señal</span>
