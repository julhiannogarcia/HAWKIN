...
import { 
  ShieldCheck, Loader2, MessageCircle, Radio as RadioIcon, 
  Layout as LayoutIcon, ShoppingBag, Target, Tv, Eye, ExternalLink 
} from 'lucide-react';

// =====================================================================
// PÁGINA B2B v23.0 - RECONSTRUCCIÓN INDESTRUCTIBLE
// =====================================================================
export default function B2BPage() {
  ...
  useEffect(() => {
    ...
    const scriptId = 'paypal-engine-v23-final';
    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden flex flex-col">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-40 pb-32 w-full flex-1">
        ...
        <section className="text-center space-y-8 mb-32">
          <span className="text-blue-400 font-black uppercase tracking-[0.4em] text-[10px]">HAWKIN GLOBAL MEDIA • SISTEMA v23.0</span>
          ...
          <p className="text-gray-500 text-xl max-w-2xl mx-auto font-light leading-relaxed text-center">
             Activación de pauta publicitaria. Sistema blindado y cobro inmediato garantizado.
          </p>
        </section>
                ...
                >
                   <div className="flex items-center gap-6">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center ${selectedId === ad.id ? 'bg-blue-500 text-black' : 'bg-white/5 text-gray-500'}`}>
                         {ad.id === 'plus' ? <RadioIcon size={24} /> : ad.id === 'sidebar' ? <LayoutIcon size={24} /> : <ShoppingBag size={24} />}
                      </div>
                      <div>
              ...
              <div className="min-h-[140px] flex flex-col items-center justify-center w-full relative pt-8 border-t border-gray-100">
                 {!isPaypalReady ? (
                   <div className="flex flex-col items-center gap-6">
                      ...
                      <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] animate-pulse">ACTIVANDO SISTEMA v23.0...</p>
                   </div>
                 ) : (
