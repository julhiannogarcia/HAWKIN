...
// =====================================================================
// PÁGINA B2B v20.1 - REINSTALACIÓN TOTAL (MODO AZUL & BLANCO)
// =====================================================================
export default function B2BPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      // Dejamos el motor activo
    };
  }, [isMounted]);

  // RENDERIZADOR DE BOTONES (ESTILO AZUL Y BLANCO)
  useEffect(() => {
        ...
        (window as any).paypal.Buttons({
          ...
          createOrder: (data: any, actions: any) => {
            return actions.order.create({
              purchase_units: [{
                description: `HAWKIN B2B v20 - ${selectedPlacement.title}`,
                amount: { 
                  currency_code: 'USD', 
                  value: selectedPlacement.priceUSD 
                }
              }],
              application_context: { 
    ...
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-40 pb-32 w-full">
        ...
        <section className="text-center space-y-8 mb-32">
          <span className="text-blue-400 font-black uppercase tracking-[0.4em] text-[10px]">HAWKIN B2B GLOBAL • REINSTALACIÓN v20.1</span>
          ...
          <p className="text-gray-500 text-xl max-w-2xl mx-auto font-light leading-relaxed">
             Publicidad de élite. Pago express localizado y activación inmediata vía satélite.
          </p>
        </section>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
           
           {/* SECTOR PLANES - ESTÉTICA AZUL/NEGRA */}
           ...
           {/* SECTOR PAGO - ESTÉTICA BLANCA/AZUL */}
           <div className="p-12 rounded-[50px] bg-white text-black space-y-10 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-4 relative z-10 text-center md:text-left">
                 ...
                 <p className="text-[8px] text-gray-400 font-bold uppercase tracking-widest">Cobro Localizado en Soles vía PayPal</p>
              </div>
              ...
              <div className="min-h-[140px] flex flex-col items-center justify-center w-full relative pt-8 border-t border-gray-100">
                 {!isPaypalReady ? (
                   <div className="flex flex-col items-center gap-6">
                      ...
                      <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.4em] animate-pulse">SISTEMA REINSTALANDO...</p>
                   </div>
                 ) : (
              ...
              <div className="pt-6 text-center">
                 ...
                 >
                    Pagar vía WhatsApp (Soporte Manual)
                 </button>
              </div>
           </div>
        </div>
