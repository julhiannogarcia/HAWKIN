    ...
    <div className="min-h-screen bg-[#FDFCF8] text-[#2C3E50] font-sans selection:bg-[#AED6F1]">
      ...
      <header className="h-20 border-b border-[#EAECEE] bg-white/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-[100]">
        <div className="flex items-center gap-4">
           <div className="w-12 h-12 bg-[#5DADE2] rounded-2xl flex items-center justify-center shadow-sm text-white font-bold text-2xl">
              H
           </div>
           <div>
      ...
      <div className="max-w-7xl mx-auto w-full min-h-[calc(100vh-80px)] flex flex-col p-6 md:p-12">
        {children}
      </div>
    </div>
  );
