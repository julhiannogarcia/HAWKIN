...
import { 
  ...
  Clock, Activity, Terminal, ExternalLink, Filter
} from 'lucide-react';
...
export default function MasterIntel() {
  ...
  const filteredNews = useMemo(() => {
    ...
    return intel.topNews.filter((n: any) => 
      ...
      n.companies?.some((c: string) => c.toLowerCase().includes(searchQuery.toLowerCase()))
    );
  }, [intel, searchQuery]);
    ...
    <div className="space-y-32">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4 p-2 bg-white/[0.02] border border-white/5 rounded-3xl backdrop-blur-3xl sticky top-24 z-[1000]">
         <div className="flex items-center gap-4 px-6 py-4 bg-black/40 rounded-2xl border border-white/5">
            ...
            <div className="flex flex-col">
               <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest">Hora Estándar HAWKIN</span>
         ...
         <div className="flex items-center gap-4 px-6 py-4 bg-black/40 rounded-2xl border border-white/5">
            ...
            <div className="flex flex-col">
               <span className="text-[7px] font-black text-gray-600 uppercase tracking-widest">Status del Sistema</span>
      ...
      <section className="max-w-4xl mx-auto space-y-8">
         <div className="relative group">
            ...
            <input 
               ...
               className="w-full bg-[#080808] border-2 border-white/5 group-hover:border-cyan-500/30 focus:border-cyan-500 p-8 pl-20 rounded-[40px] text-lg font-bold uppercase tracking-widest outline-none transition-all shadow-2xl"
            />
      ...
      <section>
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
           ...
           <p className="text-gray-600 text-sm italic font-light max-w-xs text-right">Análisis profundo de modelos, CEOs y capital estratégico.</p>
        </div>
      ...
      <div className="pt-20 text-center border-t border-white/5">
         <p className="text-[9px] font-black text-gray-700 uppercase tracking-[1.5em] animate-pulse">HAWKIN COMMAND CENTER • DECRYPTING THE FUTURE • GLOBAL INTEL FEED ACTIVE</p>
      </div>
    </div>
  );
}
